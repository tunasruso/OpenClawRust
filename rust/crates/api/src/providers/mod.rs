...
pub fn detect_provider_kind(model: &str) -> ProviderKind {
    ...
    if openai_compat::has_auth_from_env_or_saved(openai_compat::OpenAiCompatConfig::openai()) {
        return ProviderKind::OpenAi;
    }
...
mod tests {
    ...
    fn detects_provider_from_model_name_first() {
        ...
        assert_eq!(detect_provider_kind("gpt-5.1-codex-mini"), ProviderKind::OpenAi);
    }
